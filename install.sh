...
echo "     agent-route-node start                    # foreground"
echo "     nohup agent-route-node start \\"
echo "       > $INSTALL_DIR/api_bridge.log 2>&1 < /dev/null &   # background"
echo ""
echo "     For a permanent daemon on macOS, see the 'Run as a launchd"
echo "     service' section in the README."
echo ""
echo "  5. Check status:"
